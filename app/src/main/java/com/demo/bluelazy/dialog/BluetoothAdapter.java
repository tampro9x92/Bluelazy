    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(BluetoothInfo bluetoothInfo) {
            if (bluetoothInfo.getType() == BluetoothClass.Device.Major.AUDIO_VIDEO) {
                ...
                binding.imvBluetoothDevice.setImageResource(R.drawable.ic_computer_24);
            } else if (bluetoothInfo.getType() == BluetoothClass.Device.Major.WEARABLE) {
                binding.imvBluetoothDevice.setImageResource(R.drawable.ic_watch_24);
                ...
                binding.imvBluetoothDevice.setImageResource(R.drawable.ic_camera_24);
            } else if (bluetoothInfo.getType() == BluetoothClass.Device.Major.PHONE) {
                binding.imvBluetoothDevice.setImageResource(R.drawable.ic_phone_24);
            } else {
                binding.imvBluetoothDevice.setImageResource(R.drawable.ic_bluetooth);
            }
